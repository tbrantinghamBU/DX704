...
* Visit the project repository. This should be where you found this README. Otherwise, you can find it in the [course homework repository list](https://github.com/orgs/bu-cds-dx704/repositories).
* Click on **homework.ipynb** to view the notebook.
* Depending on your chosen option:
  * **Option A or C**: Click on the notebook and select **Download Raw File** to save it to your local machine. Repeat this process for any data files in the repository. <img width="221" height="85" alt="Image" src="https://github.com/user-attachments/assets/8d01095a-080b-45e3-98e9-7b1cf3dff054" />
...
2. Navigate to the downloaded **project.ipynb**.
...
1. Go to the repository for this homework. If necessary, you can find it again in the [course homework respositories list](https://github.com/orgs/bu-cds-dx704/repositories).
2. Click the green **Code** button and select **Open with Codespaces > New codespace**.
3. Once Codespaces launches, open **project.ipynb** directly from the Codespaces file list.
...
* Upload your notebook using the Gradescope link in Blackboard or by navigating from [https://www.gradescope.com/](https://www.gradescope.com/).
* Be sure to upload all the files specified in the instructions.
